            ...
            for(CBL_SocioEconomic__c socio: socioes ){
                for(CBL2_Farmer__c farmer: farmers){
                    ...
                    if(farmer.LAC_Farmer_Details__c == socio.Baseline__r.Farmer__c){
		            	...
		            	farmer.totalFamilyIncome__c= socio.totalFamilyIncome__c;
		            	farmer.mainProductProject__c= socio.mainProductProject__c;
		            	farmer.percentageOfIncomeProjectActivity__c= socio.percentageOfIncomeProjectActivity__c;
		            	farmer.manyPeopleBringFamilyIncome__c= socio.manyPeopleBringFamilyIncome__c;
		            	farmer.productionCreditNextWeek__c= socio.productionCreditNextWeek__c;
		            	farmer.productionCreditNextWeekOther__c= socio.productionCreditNextWeekOther__c;
		            	farmer.ceasedToCultivate__c= socio.ceasedToCultivate__c;
		            	farmer.dateCeasedToCultivate__c= socio.dateCeasedToCultivate__c;
		            	farmer.reasonCeasedToCultivate__c= socio.reasonCeasedToCultivate__c;
		            	farmer.productDestination__c= socio.productDestination__c;
		            	farmer.productDestinationAutoconsumo__c= socio.productDestinationAutoconsumo__c;
		            	farmer.productDestinationTrueque__c= socio.productDestinationTrueque__c;
		            	farmer.productDestinationVenta__c= socio.productDestinationVenta__c;
		            	farmer.productDestinationDonacion__c= socio.productDestinationDonacion__c;
		            	farmer.plantingDecision__c= socio.plantingDecision__c;
		            	farmer.whichProductsNotPlant__c= socio.whichProductsNotPlant__c;
		            	farmer.WhyNotPlantTheseProducts__c= socio.WhyNotPlantTheseProducts__c;  
                    }                                 
                }
            }
